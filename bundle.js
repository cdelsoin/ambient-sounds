...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSavePreset = function onSavePreset(getRain, getFire, getThunder, getCrickets, getBirds, getCoffee, getWaves, getBowl) {
	  ...
	  event.preventDefault();
	  api.savePreset(getName, getRain, getFire, getThunder, getCrickets, getBirds, getCoffee, getWaves, getBowl).done(ui.success).fail(ui.failure);
	};
	...
	var onDeletePreset = function onDeletePreset(data) {
	  ...
	  console.log(data);
	  event.preventDefault();
	  api.deletePreset(data).done(ui.success).fail(ui.failure);
	};
