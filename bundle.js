...
/***/ function(module, exports, __webpack_require__) {
	...
	var campfirePreset = function campfirePreset() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changeRainVol = function changeRainVol() {
	...
	var changeFireVol = function changeFireVol() {
	  var sliderInput = function sliderInput() {
	...
	var changeThunderVol = function changeThunderVol() {
	  var sliderInput = function sliderInput() {
	...
	var changeCricketsVol = function changeCricketsVol() {
	  var sliderInput = function sliderInput() {
	...
	var changeBirdsVol = function changeBirdsVol() {
	  var sliderInput = function sliderInput() {
	...
	var changeCoffeeVol = function changeCoffeeVol() {
	  var sliderInput = function sliderInput() {
	...
	var changeWavesVol = function changeWavesVol() {
	  var sliderInput = function sliderInput() {
	...
	var changeBowlVol = function changeBowlVol() {
	  var sliderInput = function sliderInput() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.signUp(data).done(ui.signUpSuccess).then(api.signIn(data).done(ui.signInSuccess).fail(ui.failure)).fail(ui.failure);
	};
	...
	var onGetPresets = function onGetPresets(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.getPresets(data).done(ui.getPresetsSuccess).fail(ui.failure);
	};

	var onSavePreset = function onSavePreset(event, getRain, getFire, getThunder, getCrickets, getBirds, getCoffee, getWaves, getBowl) {
	  ...
	  var getName = $('.save-input').prop('value');
	  event.preventDefault();
	  api.savePreset(getName, getRain, getFire, getThunder, getCrickets, getBirds, getCoffee, getWaves, getBowl).done(ui.savePresetSuccess).fail(ui.failure);
	};

	var onLoadPreset = function onLoadPreset(data) {
	  console.log(data);
	  event.preventDefault();
	  api.loadPreset(data).done(ui.loadPresetSuccess).fail(ui.failure);
	};

	var onDeletePreset = function onDeletePreset(data) {
	  console.log(data);
	  event.preventDefault();
	  api.deletePreset(data).done(ui.deletePresetSuccess).fail(ui.failure);
	};

	var onUpdatePreset = function onChangePresetName(id, getRain, getFire, getThunder, getCrickets, getBirds, getCoffee, getWaves, getBowl) {
	  event.preventDefault();
	  ...
	  getWaves = $(".wavesSlider").prop('value');
	  getBowl = $(".bowlSlider").prop('value');
	  api.updatePreset(id, getRain, getFire, getThunder, getCrickets, getBirds, getCoffee, getWaves, getBowl).done(ui.success).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var savePreset = function savePreset(getName, getRain, getFire, getThunder, getCrickets, getBirds, getCoffee, getWaves, getBowl) {
	  return $.ajax({
	    url: app.api + '/presets/',
	    method: 'POST',
	    headers: {
	...
	var loadPreset = function loadPreset(data) {
	  return $.ajax({
	...
	var deletePreset = function deletePreset(data) {
	  return $.ajax({
	    url: app.api + '/presets/' + data,
	    method: 'DELETE',
	    headers: {
	...
	var updatePreset = function updatePreset(id, getRain, getFire, getThunder, getCrickets, getBirds, getCoffee, getWaves, getBowl) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPresetsSuccess = function getPresetsSuccess(data) {
	  var showPresets = __webpack_require__(10);
	...
	var loadPresetSuccess = function loadPresetSuccess(data) {
	...
	var updatePresetSuccess = function updatePresetSuccess(data) {
	  var showPresets = __webpack_require__(10);
	  $('.presets-container').html(showPresets({
	    presets: data.presets
	  }));
	...
	var savePresetSuccess = function savePresetSuccess(data) {
	  $('.get').click();
	  console.log(data);
	};

	var deletePresetSuccess = function deletePresetSuccess(data) {
	  $('.get').click();
	  console.log(data);
	};
	...
	module.exports = {
	  ...
	  getPresetsSuccess: getPresetsSuccess,
	  loadPresetSuccess: loadPresetSuccess,
	  updatePresetSuccess: updatePresetSuccess,
	  changePassSuccess: changePassSuccess,
	  savePresetSuccess: savePresetSuccess,
	  deletePresetSuccess: deletePresetSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<h4 class=\"presets-name\">  "
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + " </h4>\n<form class=\"presets-buttons\">\n  <button id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"load\"> Load </button>\n  <button id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"update\"> Save </button>\n  <button id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"delete\"> Delete </button>\n</form>\n<br>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.presets : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(6);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
