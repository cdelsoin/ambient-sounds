...
/***/ function(module, exports, __webpack_require__) {
	...
	var onDeletePreset = function onDeletePreset() {
	  var data = $('.delete-input').prop('value');
	  console.log(data);
	  event.preventDefault();
	  api.deletePreset(data).done(ui.success).fail(ui.failure);
	};

	var onChangePresetName = function changePresetName() {
	  var newName = $('.update-input').prop('value');
	  var id = $('.update').prop('id');
	  api.changePresetName(id, newName).done(ui.success).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changePresetName = function changePresetName(id, newName) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changePresetNameSuccess = function changePresetNameSuccess(data) {
	  var showPresets = __webpack_require__(10);
	  $('.presets-container').html(showPresets({
	    presets: data.presets
	  }));
	...
	module.exports = {
	  ...
	  changePresetNameSuccess: changePresetNameSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<h4> id:"
	    ...
	    + " </h4>\n<input class=\"update-input\" type=\"text\" placeholder=\"Rename Your Preset\"><br>\n<button id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"update\">  Update Name </button>\n<button id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"load\"> Load "
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + " </button>\n\n";
